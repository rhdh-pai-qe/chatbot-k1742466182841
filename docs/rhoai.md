...
3) Access the `workbench` named `chatbot-k1742466182841-notebook`.
...
5) In the terminal, run `cd chatbot-k1742466182841` to navigate to your sample app's directory.
